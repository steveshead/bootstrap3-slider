...
if($_POST)
{
	$to_email   	= "me@here.com"; //Recipient email, Replace with own email here
	...
	if(!$send_mail)
	{
		...
		Hi '.$user_name .', Thank you very much for your message,we will get back to you as soon possible.</div>'));
		die($output);
	}
}
?>